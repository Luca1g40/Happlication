...
export default function SearchProduct(){
    ...
    <div>
        ...
        <OverviewTable tableHeads={["name","category","price","details"]} items={filteredProducts} navigate={id=>navigate(`/productdetails/${id}`)} leaveOutList={["ingredients","productDestination","id"]}
