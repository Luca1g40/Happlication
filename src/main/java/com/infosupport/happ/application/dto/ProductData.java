...
public class ProductData {
    ...
    public ProductData(Long id, String name, String productCategoryName, double price, List<Ingredient> ingredientList, String details, ProductDestination productDestination, ProductType productType) {
        this.id = id;
        this.name = name;
